...
@protocol CZZCarouselViewDelegate <NSObject>
 ...
 *  其他属性都有默认值，可不设置
 */
@interface CZZCarouselView : UIView
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<CZZCarouselViewDelegate> delegate;
